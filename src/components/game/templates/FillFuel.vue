...
<template>
  ...
  <div class="center-horizontal">
    <p class="text-center">Halten den Knopf gedrückt, um das Öl aufzufüllen</p>
  </div>
  ...
  <div class="center-horizontal">
    <div class="relative center-horizontal max-width">
      ...
      <div class="absolute fuel-progress"></div>
    </div>
  </div>
  ...
  <div class="center-horizontal">
    <img src="../../../assets/tasks/lamp.png" class="fuel-icon">
  </div>

  <div style="height: 20px"></div>

  <div class="center-horizontal">
    <HoldButton title="Öl auffüllen" @down="startIncrease" @up="startDecrease"/>
  </div>
