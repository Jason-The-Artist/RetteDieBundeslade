...
<template>
  ...
  <TaskDescriptionPopup :show="taskShow" @clicked="onClicked" title="Rechnen" text="Ein Israelit will wissen, wie gut du addieren kannst. Zeige ihm was du drauf hast."/>
...
export default {
  ...
  methods: {
    ...
    createTerm(){
      let t1 = this.getRandom(30)
      let t2 = this.getRandom(30)
      this.solution = t1+t2
      this.term = t1 + " + " + t2
    },
